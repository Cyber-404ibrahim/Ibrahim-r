...
def banner():
    print("""
%s_______________  ___________ __________Ibrahim
██╗██████╗ ██████╗  █████╗ ██╗  ██╗██╗███╗   ███╗    
██║██╔══██╗██╔══██╗██╔══██╗██║  ██║██║████╗ ████║    
██║██████╔╝██████╔╝███████║███████║██║██╔████╔██║    
██║██╔══██╗██╔══██╗██╔══██║██╔══██║██║██║╚██╔╝██║    
...
%s |
%s[•] AUTHOR : %ibrahim
[•] GITHUB : https://github.com/Cyber-404ibrahim
[•] WHATSAPP : +8801611590876
%s |------------------"""%(B,p,B,p,B,p,B,p,B))
...
def check_in(user, pasw):
    ...
    #        jalan '  \033[0;33m[\033[0;36m' + str(opt + 1) + '\033[0;33m]\033[0;00m ' + proo[opt]
        ...
        jalan("%s[•] Ibrahim-r password telah dinganti"%(m))
